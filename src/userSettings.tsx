...
export const welcomeSettings: WelcomeSettings = {
  ...
  title: "Looties",
  desc: "Powered by AROX",

  // Countdown Timer
  countdownEnable: true,
  countdownTo: date('31 May 2022 18:00:00 UTC'),
  //Example date below
...
export const whitelistSettings: WhitelistSettings = {
  ...
  startDate: date('31 May 2022 15:00:00 UTC'),
  endDate: date('31 May 2022 20:00:00 UTC'),
  countdown: false,
  //Example date below
  // date('29 2021 00:00:00 GMT')
...
export const publicSaleSettings: PublicSaleSettings = {
  ...
  startDate: date("31 May 2022 20:00:00 UTC"),
  endDate: undefined,
  countdown: false,
  //Example date below
  // date('29 2021 00:00:00 GMT')
